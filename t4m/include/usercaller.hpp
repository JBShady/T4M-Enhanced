...
namespace uc
{
    ...
    template <>
    struct abi<> : detail::abi_impl<void_ret<void>>
    {
    };

    template <loc Where, typename T, typename... ArgSpecs>
    struct abi<ret<Where, T>, ArgSpecs...> : detail::abi_impl<ret<Where, T>, ArgSpecs...>
    {
    };

    template <loc_pair Where, typename T, typename... ArgSpecs>
    struct abi<ret64<Where, T>, ArgSpecs...> : detail::abi_impl<ret64<Where, T>, ArgSpecs...>
    {
    };

    template <loc Where, typename T, typename... ArgSpecs>
    struct abi<arg<Where, T>, ArgSpecs...> : detail::abi_impl<void_ret<void>, arg<Where, T>, ArgSpecs...>
    {
    };
